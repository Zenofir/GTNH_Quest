...
export class ProjectData {
    ...
    static readonly infoQuest: quest[] = [
        ...
        },
        {
            ...
            x: 0,
            y: 0,
            data: `<br/>§c§l${ProjectConfig.projectDsc_zh}§r<br/><br/>§l作者:§r §9§l<a class="githubLink" href="https://github.com/MCTBL" target="_blank">${ProjectConfig.projectAuthor[0]}</a><img src='static/MCTBL.png'/>§r、 §3§l<a class="githubLink" href="https://github.com/NoRainLand" target="_blank">${ProjectConfig.projectAuthor[1]}</a><img src='static/Norainland.png'/>§r<br/><br/>§l项目地址: [url]${ProjectConfig.projectUrl}[/url]§r<br/>- 有任何问题或需求前往仓库提交issue即可<br/><br/><br/><br/>§l滚轮§r可对图表进行缩放，§l左键§r可拖动<br/><br/>§l快捷键：§r<br/>§lR§r - 重置图表<br/>§lH§r - 快速开启/隐藏任务线侧边栏<br/>§lESC / E§r - 退出任务详情，或直接点击任务框外侧黑色区域即可<br/><br/>`,
            quest_id: "",
            tooltip: "",
            is_main: 0,
        },
